...
// All markers are the same size for consistency
function createMarkerIconHtml(index: number): string {
  ...
  if (isRanked) {
    // Same size marker with number inside for ranked items
    return `<svg width="20" height="28" viewBox="0 0 20 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="10" y="13" text-anchor="middle" fill="white" font-size="9" font-weight="700" font-family="system-ui, -apple-system, sans-serif">${rank}</text>
    </svg>`;
  } else {
